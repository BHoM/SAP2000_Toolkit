...
{
    public class SteelUtilizationRequest : IStructuralResultRequest
    {
        /***************************************************/
        /**** Properties                                ****/
        /***************************************************/
        ...
        [Description("Defines which bars results should be pulled for. If nothing is provided, results for all bars will be assumed.")]
